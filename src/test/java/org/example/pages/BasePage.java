...
public abstract class BasePage {
    ...
    public String getTextByAttribute(By locator, String atributteName) {
        return this.driver.findElement(locator).getAttribute(atributteName);
    }
